...
@DynamoDBDocument
public class SubElementInference {
	String key;
	String value;
	String imageId;
	String confidence;
	...
	public SubElementInference() {
	}

	public SubElementInference(String key, String value, String image, String confidence,String modelVersion,String source) {
		super();
		this.key = key;
		this.value = value;
		this.imageId = image;
